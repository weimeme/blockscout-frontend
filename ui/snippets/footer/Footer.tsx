...
const Footer = () => {
  ...
  const BLOCKSCOUT_LINKS = [
    ...
    // },
    {
      ...
      iconSize: '18px',
      text: 'Twitter',
      url: 'https://twitter.com/SuperExet',
    },
    {
      icon: 'social/discord' as const,
      iconSize: '24px',
      text: 'Discord',
      url: 'https://discord.gg/superex',
    },
    // {
  ...
  const renderProjectInfo = React.useCallback((gridArea?: GridProps['gridArea']) => {
    return (
      <Box gridArea={ gridArea }>
        <Link fontSize="xs" href="https://scschain.com" color="link_hovered">scschain.com</Link>
        <Text mt={ 3 } fontSize="xs">
        SCS Chain is using Blockscout as a tool for inspecting and analyzing EVM based blockchains. Blockchain explorer for SCS Chain Networks.
        </Text>
        <VStack spacing={ 1 } mt={ 6 } alignItems="start">
          ...
          { frontendLink && (
            <Text fontSize="xs">
              Frontend:<Link color="link_hovered" href='https://github.com/blockscout/frontend/tree/v1.22.0' target="_blank"> v1.22.0</Link>
            </Text>
          ) }
        </VStack>
      </Box>
